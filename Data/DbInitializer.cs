    ...
    public static class DbInitializer
    {
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            var products = new List<Product>
            {
                ...
                new Product{Name="Tomato",Price=(decimal)17.46,CategoryID=1,Description="Meosjaengi tomato (tomato)",Modified=DateTime.Now},
                new Product{Name="Dasda",Price=(decimal)12.16,CategoryID=5,Description="Meosjaengi tomato (tomato)",Modified=DateTime.Now},
                new Product{Name="Orange juice",Price=(decimal)3.46,CategoryID=4,Description="Orange Orange Orange",Modified=DateTime.Now}
            };
