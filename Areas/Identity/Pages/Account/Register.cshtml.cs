...
namespace WebApplicationRB.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [DataType(DataType.Password)]            
            [Display(Name = "Password_confirm", ResourceType = typeof(Resources.Resource))]
            [Compare("Password", ErrorMessageResourceName = "Password_confirm_not_match", ErrorMessageResourceType = typeof(Resource))]//"The password and confirmation password do not match.")]
